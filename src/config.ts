...
const notifications = {
  ...
  discord: {
    ...
    notifyGroupSeries: {
      ...
      '9mm': envOrArray(process.env.DISCORD_NOTIFY_GROUP_TEST),
      '5.56x45mm': envOrArray(process.env.DISCORD_NOTIFY_GROUP_TEST),
      '.223rem': envOrArray(process.env.DISCORD_NOTIFY_GROUP_TEST),
      '454': envOrArray(process.env.DISCORD_NOTIFY_GROUP_TEST)
    },
...
const store = {
  ...
  maxPrice: {
    series: {
      ...
      '9mm': envOrNumber(process.env.MAX_PRICE_SERIES_TEST),
      '5.56x45mm': envOrNumber(process.env.MAX_PRICE_SERIES_TEST),
      '.223rem': envOrNumber(process.env.MAX_PRICE_SERIES_TEST),
      '454': envOrNumber(process.env.MAX_PRICE_SERIES_TEST),
    },
  },
